...
<CardGroup cols={2}>
  ...
  <Card title="OrcaRouter" icon="fa-solid fa-cloud" href="/providers/orcarouter">
    Model routing gateway. Access 150+ models from OpenAI, Anthropic, Google, DeepSeek and more through one endpoint.
  </Card>
  <Card title="Cheaper Inference" icon="fa-solid fa-cloud" href="/providers/cheaperinference">
    OpenAI-compatible gateway. Access models from OpenAI, Anthropic, Google, DeepSeek, Z.ai and more through one endpoint.
  </Card>
</CardGroup>
