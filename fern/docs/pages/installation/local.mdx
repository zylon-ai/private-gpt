...
Use [Detailed Model Configuration](/manual/advanced) to generate `settings-model.yaml`, tune model settings in more detail, and run local `uv` with `PGPT_PROFILES=model`.
