...
- LLM: "ollama", "llama-cpp", "sagemaker", "openai", "openailike", "azopenai", "gemini"
- Embeddings: "ollama", "huggingface", "openai", "sagemaker", "azopenai", "gemini"
- Vector stores: "qdrant", "chroma", "postgres", "clickhouse"
...
- llms-gemini: adds support for Gemini LLM, requires Gemini API key
...
- embeddings-gemini: adds support for Gemini Embeddings, requires Gemini API key
