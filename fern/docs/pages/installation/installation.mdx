It is important that you review the [Main Concepts](/installation/getting-started/main-concepts) section to understand the different components of PrivateGPT and how they interact with each other.
