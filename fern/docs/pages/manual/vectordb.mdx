...
| Field        | Description |
|--------------|-------------|
| uri     | Default is set to "local_data/private_gpt/milvus/milvus_local.db" as a local file, you can also set up a more performant Milvus server on docker or k8s.|
