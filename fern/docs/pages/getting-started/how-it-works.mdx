...
Then edit `settings-model.yaml` to tune tokenizer, context window, and sampling parameters. See [Detailed Model Configuration](/manual/advanced) for a full walkthrough.
