...
class IngestService:
    ...
    def _ingest_data(
        ...
        with tempfile.NamedTemporaryFile(delete=False) as tmp:
            try:
                ...
                return self.ingest_file(file_name, path_to_tmp, collection_name=collection_name)
            finally:
                tmp.close()
                path_to_tmp.unlink()
    ...
    def ingest_bin_data(
        ...
        return self._ingest_data(file_name, file_data, collection_name=collection_name)
