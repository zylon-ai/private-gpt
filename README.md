...
Copy the downloaded model into the new created 'models' directory.
...
The supported extensions are:
   ...
   - `.txt`: Text file (UTF-8),
   - `.py`: PythonLoader (added by Nikos Mparoutis)
...
- `GPT4` added but need your credentials. Atention , it bills you and do not expose them publicly
