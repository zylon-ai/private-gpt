...
ZYLON_ONLY_REGISTRY: list[TypeMapping] = [
    ...
    TypeMapping(
        sdk_type=None,
        our_type=BashCodeExecutionResultBlock,
        sdk_schema_name="BashCodeExecutionResultBlock",
        openapi_schema_name=None,
        zylon_only_fields=_BASE_ZYLON_FIELDS,
        sdk_only_fields=frozenset(),
        sdk_sample={
        ...
        notes="Inner content block nested inside BashCodeExecutionToolResultBlock.content.",
    ),
    TypeMapping(
        sdk_type=None,
        our_type=BashCodeExecutionToolResultBlock,
        sdk_schema_name="BashCodeExecutionToolResultBlock",
        openapi_schema_name=None,
        zylon_only_fields=_CACHEABLE_ZYLON_FIELDS | {"is_error"},
        sdk_only_fields=frozenset(),
        sdk_sample={
        ...
        notes="Not in Python SDK yet — follows OpenAPI spec.",
    ),
    TypeMapping(
        sdk_type=None,
        our_type=TextEditorCodeExecutionViewResultBlock,
        sdk_schema_name="",
        openapi_schema_name=None,
        zylon_only_fields=_BASE_ZYLON_FIELDS,
        sdk_only_fields=frozenset(),
        sdk_sample={},
        notes="Inner result block (type: text_editor_code_execution_view_result)",
        skip=True,
    ),
    TypeMapping(
        sdk_type=None,
        our_type=TextEditorCodeExecutionCreateResultBlock,
        sdk_schema_name="",
        openapi_schema_name=None,
        zylon_only_fields=_BASE_ZYLON_FIELDS,
        sdk_only_fields=frozenset(),
        sdk_sample={},
        notes="Inner result block (type: text_editor_code_execution_create_result)",
        skip=True,
    ),
    TypeMapping(
        sdk_type=None,
        our_type=TextEditorCodeExecutionStrReplaceResultBlock,
        sdk_schema_name="",
        openapi_schema_name=None,
        zylon_only_fields=_BASE_ZYLON_FIELDS,
        sdk_only_fields=frozenset(),
        sdk_sample={},
        notes="Inner result block (type: text_editor_code_execution_str_replace_result)",
        skip=True,
    ),
    TypeMapping(
        sdk_type=None,
        our_type=TextEditorCodeExecutionToolResultBlock,
        sdk_schema_name="TextEditorCodeExecutionToolResultBlock",
        openapi_schema_name=None,
        zylon_only_fields=_CACHEABLE_ZYLON_FIELDS | {"is_error"},
        sdk_only_fields=frozenset(),
        sdk_sample={
